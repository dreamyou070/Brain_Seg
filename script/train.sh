...
file_name="2_segmentation_model_c_with_binary_instance_norm_relu_crossentropy_focal_loss"
# #--do_attn_loss
#--aggregation_model_b --aggregation_model_b
