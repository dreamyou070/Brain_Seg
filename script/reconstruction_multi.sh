...
file_name="3_multi_segmentation_BraTS2020"

accelerate launch --config_file ../../../gpu_config/gpu_0_config \
 --main_process_port $port_number ../reconstruction_multi.py \
 --pretrained_model_name_or_path ../../../pretrained_stable_diffusion/stable-diffusion-v1-5/v1-5-pruned.safetensors \
 --network_dim 64 --network_alpha 4 \
 --data_path "/home/dreamyou070/MyData/anomaly_detection/medical/brain/BraTS2020_Segmentation_multisegment/val" \
 ...
 --threds [0.4,0.5,0.6] --use_position_embedder --test_with_xray